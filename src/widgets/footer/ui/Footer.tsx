...
const defaultFooterData: FooterData = {
  brandName: 'Studio.',
  brandDescription: 'Создаем сайты, которые стимулируют рост бизнеса. Производительность, масштабируемость и превосходный дизайн без компромиссов.',
  linkColumns: [
    {
      title: 'Услуги',
      links: [
  ...
  socialLinks: [
    { platform: 'telegram', url: 'https://t.me/awaitMeBro' },
  ],
...
export function Footer({ data }: FooterProps) {
  ...
  const copyrightText = footerData.copyrightText?.replace('{year}', String(currentYear)) || `© ${currentYear} Studio. Все права защищены.`
