      ...
      <Container>
        ...
        <AnimatedSection stagger>
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            <div className="hidden md:block absolute top-12 left-0 w-full h-0.5 bg-gradient-to-r from-bg-elevated via-accent-primary to-bg-elevated opacity-30 z-0" />
            ...
            {steps.map((step, i) => (
              <div key={i} className="relative z-10 flex flex-col items-center text-center group">
                <div className="w-24 h-24 rounded-2xl bg-bg-secondary border border-white/10 flex flex-col items-center justify-center mb-6 shadow-xl group-hover:-translate-y-2 transition-transform duration-300">
                  ...
                  <span className="text-xs text-text-muted mt-1">{step.duration}</span>
                </div>
